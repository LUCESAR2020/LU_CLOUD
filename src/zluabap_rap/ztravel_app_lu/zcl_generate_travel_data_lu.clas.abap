CLASS zcl_generate_travel_data_lu DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_lu IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

  DATA ITAB TYPE TABLE OF ZTRAVEL_DT_LU.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_dt_lu.

*   insert the new table entries
    INSERT ztravel_dt_lu FROM TABLE @itab.
